...
// Middleware ,'https://merabestie.com','https://hosteecommerce.vercel.app'
app.use(cors({
  origin: ['http://127.0.0.1:5500','https://merabestie.com','https://hosteecommerce.vercel.app'], 
  credentials: true,
...
mongoose.connect('mongodb://localhost:27017/clothing_ecommerce')
  ...
  try {
    ...
    switch(normalizedCategory) {
      ...
      case 'trendy':
        ...
        break;
      case 'denim':
        searchCategory = 'Jeans';
        break;
      case 'wintercollections':
        searchCategory = 'Winter Collections';
        break;
      default:
...
app.post('/create-product', async (req, res) => {
  try {
      const { name, price, category, rating, productId, inStockValue, soldStockValue, visibility } = req.body;
      const imagePath = '/images/' + req.file.filename;

      // Create a new product (assuming Product model is set up)
...
//       inStockValue: productData.inStockValue,
//       soldStockValue: productData.soldStockValue,
